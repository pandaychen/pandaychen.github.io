...
####	最基本的方法
1、服务端<br>
[引用](https://github.com/avinassh/grpc-errors/blob/master/go/server.go#L24)
```golang
...
所以就引出了问题：
问题 1：如何优雅的判断 gRPC 的错误，基于 `code` 还是 `message`？
问题 2：如何使用 `github.com/pkg/errors` 提供的方法，判断错误类型？
